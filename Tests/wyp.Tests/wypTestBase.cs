...
namespace wyp.Tests
{
    public abstract class wypTestBase : AbpIntegratedTestBase
    {
        protected wypTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<wypApplicationModule>();
            modules.Add<wypDataModule>();
        }

        public void UsingDbContext(Action<wypDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<wypDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<wypDbContext, T> func)
        {
            T result;
